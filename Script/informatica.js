...
<div class="produto">
<img src="${dados.imagem}" alt="" style='height: 100px;'>
<div class="nome">${dados.nome}</div>
<div class="marca">${dados.marca}</div>
<div class="preco">R$ ${dados.preco}</div>
<button class='butAdd' style='display:flex; cursor:pointer; align-items:center; gap:5px;' id='pro${dados.id}')'>adicionar  <img src='./Assets/botoes/add_product_car2.svg' style='height:20px;fill:white;'></button>
</div>`;
    }
  }
}
